// VoiceLearn - LM API Provider Information
    ...
    private static var assemblyAIInfo: LMAPIProviderInfo {
        LMAPIProviderInfo(
            ...
            fullDescription: """
                ...
                """,
            usageInApp: """
                VoiceLearn uses AssemblyAI to transcribe your voice in real-time during tutoring \
    ...
    private static var deepgramInfo: LMAPIProviderInfo {
        LMAPIProviderInfo(
            ...
            fullDescription: """
                ...
                """,
            usageInApp: """
                VoiceLearn uses Deepgram in two ways:
    ...
    private static var openAIInfo: LMAPIProviderInfo {
        LMAPIProviderInfo(
            ...
            fullDescription: """
                ...
                """,
            usageInApp: """
                VoiceLearn uses OpenAI's GPT models as the "brain" of the AI tutor:
    ...
    private static var anthropicInfo: LMAPIProviderInfo {
        LMAPIProviderInfo(
            ...
            fullDescription: """
                ...
                """,
            usageInApp: """
                VoiceLearn can use Claude as an alternative AI tutor brain:
    ...
    private static var elevenLabsInfo: LMAPIProviderInfo {
        LMAPIProviderInfo(
            ...
            fullDescription: """
                ...
                """,
            usageInApp: """
                VoiceLearn uses ElevenLabs to give the AI tutor a natural, engaging voice:
    ...
    private static var liveKitInfo: LMAPIProviderInfo {
        LMAPIProviderInfo(
            ...
            usageInApp: """
                ...
                **Note:** LiveKit is optional. VoiceLearn works without it using direct \
