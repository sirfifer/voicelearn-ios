// VoiceLearn - API Provider Detail View
...
public struct APIProviderDetailView: View {
    ...
    private var usageSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            SectionHeader(title: "How VoiceLearn Uses It", icon: "app.badge")
...
public struct SessionCostOverviewView: View {
    ...
    private var introSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("""
                VoiceLearn uses multiple AI services during a tutoring session. \
